                            ...
                            <div className="RightMyAppointtBox">
                                            ...
                                            <div className="CardBottomTextBox">
                                                ...
                                                <ul className="AppoBottomList">
                                                    ...
                                                    <li className="OrangeList">
                                                        <span className="TimeSpan DelayTimeSpan">Delay (2)</span>
                                                        <span className="DisabledText">20:30</span> to 22:30
                                                    </li>
                                                    <li className="OrangeList">
                                ...
                                <div className="Card NoteBox">
                                    ...
                                    <ul className="NoteBtnList" style={{display: "none"}}>
                                        <li><button className="DeleteBtn">Edit Note</button></li>
                                        <li><button className="EditBtn">Delete Note</button></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
