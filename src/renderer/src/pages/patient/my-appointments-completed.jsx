                ...
                <div className="TabContent">
                    {activeTab === 'all' && (
                        <div id="all" className="TabContentBlock">
                                    ...
                                    <div className="RowSec">
                                        ...
                                        <div className="HalfSec">
                                            ...
                                            <div className="Card RightMyAppointmentCard2">
                                                <button className="AddNoteBtn" onClick={toggleModal2}><img src={AddIcon} alt="Doctor image" /> Add a note</button>
                                            </div>
                                            <div className="Card RightMyAppointmentCard2">
                                                <button className="RelatedBtn"><img src={RelatedDocumentIcon} alt="Doctor image" /> Access related document</button>
                                            </div>
                                            <div className="Card RightMyAppointmentCard2">
                                                <button className="WriteReviewBtn" onClick={toggleModal}><img src={WriteReviewDisabledIcon} alt="Doctor image" /> Write a review</button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            {showModal && (
                                <div className="modal WriteReviewModal" onClick={toggleModal}>
                                    <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                                        ...
                                        <ul className="ButtonList">
                                            <li><button className="CancelBtn" onClick={toggleModal}>Not Now</button></li>
                                            <li><button className="ModalCloseBtn" onClick={toggleModal}>Submit</button></li>
                                        </ul>
                                    </div>
                                </div>
                            )}
                            {showModal2 && (
                                <div className="modal AddNoteModal" onClick={toggleModal2}>
                                    <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                                        ...
                                        <ul className="ButtonList">
                                            <li><button className="CancelBtn" onClick={toggleModal2}>Canel note</button></li>
                                            <li><button className="ModalCloseBtn" onClick={toggleModal2}>Submit</button></li>
                                        </ul>
                                    </div>
                                </div>
                            )}
